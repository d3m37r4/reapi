...
// CBasePlayer::Drop_Afk hook
typedef IHookChainClass<void, class CBasePlayer> IReGameHook_CBasePlayer_Drop_Afk;
typedef IHookChainRegistryClass<void, class CBasePlayer> IReGameHookRegistry_CBasePlayer_Drop_Afk;
...
public:
	...
	virtual IReGameHookRegistry_CBasePlayer_Drop_Afk *CBasePlayer_Drop_Afk() = 0;
};
